...
const ABOUT_LOCATION = {
  ...
  children: [
    ...
    },
    {
      ...
      description: [
        "Hey! I’m Dibyajyoti 👋 I’m a developer who enjoys building things for the web.",
        "Lately I’ve been focused on building course platforms for content creators who want to host and sell their courses on their own website.",
        "I work on both the frontend and backend, building the UI, handling payments, and making sure everything runs smoothly behind the scenes.",
        "I’m still learning every day, experimenting with ideas, and improving my projects step by step.",
        "My goal is simple: build course platforms that are fast, reliable, and easy for creators and their students to use.",
      ],
    },
  ],
};
